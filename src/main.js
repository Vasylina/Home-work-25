...
console.log(createDomElement('p', 'This paragraph has been added to the specified container.', document.body))
...
document.cookie = `userInfo=${encodeURIComponent(userInfo)}; max-age=10`
}

console.log(setUserInfoCookie('language', 'en'))
